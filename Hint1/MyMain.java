...
public class MyMain {
	...
	public static void testMyQueue() {
		...
		// 2. isEmpty
		// -------------------------------------
		System.out.println("Is it empty: " + m.isEmpty()); // --> The current length is 0 as myStaticQueue is created
															// initially empty
	...
	/**
	 * Main Method:<br>
	 * Calls to the function testMyQueue to test MyStaticQueue and its
	 * implementation.<br>
	 * 
	 * @param args:
	 *            We will run the program parameter free, so do not worry about it.
	 */
